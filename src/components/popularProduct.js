...
const PopularProduct = () => {
    ...
    const fetchProducts = async () => {
        const response = await apiGetProducts({ limit: 9, page: 1, sort: "-productSold" });
    ...
    return (
        <div className="w-main ">
            <h3 className="text-[20px] font-semibold py-[15px] border-b-2 border-main">POPULAR PORODUCTS</h3>
